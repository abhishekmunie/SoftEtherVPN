...
INSTALL_VPNSERVER_DIR=${INSTALL_VPNSERVER_DIR:-"/usr/vpnserver/"}
INSTALL_VPNBRIDGE_DIR=${INSTALL_VPNBRIDGE_DIR:-"/usr/vpnbridge/"}
INSTALL_VPNCLIENT_DIR=${INSTALL_VPNCLIENT_DIR:-"/usr/vpnclient/"}
INSTALL_VPNCMD_DIR=${INSTALL_VPNCMD_DIR:-"/usr/vpncmd/"}
